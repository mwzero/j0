...
| Delete a file     | Single file: `<call:file_delete filename="nome_file" approval="required"></call>` or pattern: `<call:file_delete foldername="cartella" pattern="*" approval="required"></call>` |
...
| Delete folder     | `<call:dir_delete foldername="nome_cartella" approval="required" sideeffect="true"></call>`                       |
