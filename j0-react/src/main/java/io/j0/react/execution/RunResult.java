...
/**
 * Result of executing any artifact (agent, tool, skill).
 */
@Data
public class RunResult {
    ...
    /**
     * Creates a PENDING result indicating the execution is waiting for external input.
     *
     * @param executionId the execution ID to use when resuming
     * @return a RunResult with PENDING status
     */
