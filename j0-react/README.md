...
hubbers-react/
├── pom.xml
├── src/main/java/org/hubbers/react/
│   ├── HubberAgentLoop.java
│   ├── ReactAgentConfig.java
│   ├── ArtifactCatalogBuilder.java
│   ├── model/
│   ├── provider/
│   ├── tool/
│   └── memory/
└── src/test/
    ├── java/org/hubbers/react/
    │   ├── HubberAgentLoopTest.java
    │   └── tool/
    └── resources/org/hubbers/react/
```
